...
%% Optimize
% =========================================================================
% LỰA CHỌN PHƯƠNG PHÁP TỐI ƯU HÓA
% Hãy thay đổi biến opt_method thành một trong các giá trị sau:
%   1. 'ILS'         : Thuật toán Iterative Least Squares gốc
%   2. 'FA_Standard' : Thuật toán Firefly Cơ bản (Random Init, Basic Cost)
%   3. 'FA_Improve'  : Thuật toán Firefly Cải tiến (Smart Init, Manual Weights)
% =========================================================================

%opt_method = 'ILS';
%opt_method = 'FA_Standard';
opt_method = 'FA_Improve';
fprintf('Dang chay toi uu hoa bang phuong phap: %s ...\n', opt_method);
...
switch opt_method
    ...
    case 'FA_Standard'
        % 2. Firefly Standard
        % instr = [So_dom_dom, So_vong_lap]
        instr = [200, 500]; 
        % Gọi hàm: firefly_standard(instr, Aq, PdM, alpha_idx, M)
        W_ref(:, 1) = firefly_standard(instr, Aq, PdM, alpha, M);
        
    case 'FA_Improve'
        % 3. Firefly Improved
        % instr = [So_dom_dom, So_vong_lap]
        instr = [100, 800]; 
        % Gọi hàm: firefly_improve(instr, Aq, PdM, alpha_idx, M, eqDir, W0)
        W_ref(:, 1) = firefly_improve(instr, Aq, PdM, alpha, M, eqDir, W0);
end
% =========================================================================
